...
can implement and test. In graduate courses I have co-developed, I emphasize this
path from formulation to implementation so that students leave able to build, not
only to recite.
...
At Purdue University, in the Lyles School of Civil and Construction Engineering,
I co-developed the curriculum for a new graduate course, CE 661 Algorithms in
Transportation, and served as a teaching assistant for graduate courses including
CE 597 Network Models for Connected and Autonomous Vehicles, CE 597 Smart
Logistics, and CE 597 Data Science for Smart Cities, for which I developed online
material delivered on edX.

At Seoul National University, in the Department of Civil and Environmental
Engineering, I served as a lecturer for Introduction to Civil and Environmental
Engineering, and as a teaching assistant for courses including Sustainable
Transportation Systems, Advanced Transportation Operation, Leadership for Civil
Engineers, and Introduction to Transportation Engineering.

## Mentoring

I have mentored undergraduate researchers at Purdue, work that contributed to a
poster presentation at the 2025 CERIAS Cybersecurity Symposium on route guidance
